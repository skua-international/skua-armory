    ...
    class BLK_opscore_2: VSM_M81_OPS {
        HEARING_PROTECTION_PELTOR;
    };
    class BLK2_opscore: VSM_M81_OPS_2 {
        HEARING_PROTECTION_PELTOR;
    };
    class Arid_Helmet_IA: ItemCore {
        HEARING_PROTECTION_PELTOR;
    };
    class ARD_opscore: VSM_M81_OPS {
        HEARING_PROTECTION_PELTOR;
    };
    class ARD_opscore_2: VSM_M81_OPS_2 {
        HEARING_PROTECTION_PELTOR;
    };
    class White_opscore: VSM_M81_OPS {
        HEARING_PROTECTION_PELTOR;
    };
    class Alpine_opscore: VSM_M81_OPS {
        HEARING_PROTECTION_PELTOR;
    };
    class White_opscore_2: VSM_M81_OPS_2 {
        HEARING_PROTECTION_PELTOR;
    };
    class Alpine_opscore_2: VSM_M81_OPS_2 {
        HEARING_PROTECTION_PELTOR;
    };
    class AOR2_Helmet_IA: ItemCore {
        HEARING_PROTECTION_PELTOR;
    };
    class AOR2_opscore: VSM_M81_OPS {
        HEARING_PROTECTION_PELTOR;
    };
    class AOR2_opscore_2: VSM_M81_OPS_2 {
        HEARING_PROTECTION_PELTOR;
    };
